#Case study: H2O potential energy (without PCA).
library(invgamma)
library(lhs)
library(abind)
library(mlegp)
...
#newG=cbind(newG,xx_test)

t1=Sys.time()
sphmc_0.8=bayesian_bridge_sphmc_adp_convergence2(xx_train,y_train,prior_var,G,n_in,n_adpt=n_out*0.8,n_out_min=n_out*1.5,n_out_max=n_out*3,q_norm=0.8,r)
t2=Sys.time()
t_sphmc_0.8=difftime(t2,t1,units='mins')

sphmc_0.8_pred=bayesian_bridge_predict(xx_train,y_train,G,xx_test,newG,sphmc_0.8)
rmse_sphmc_0.8 <- sqrt(mean((sphmc_0.8_pred-y_test)^2))/sd(y_test)

t1=Sys.time()
sphmc_1=bayesian_bridge_sphmc_adp_convergence2(xx_train,y_train,prior_var,G,n_in,n_adpt=n_out*0.8,n_out_min=n_out*1.5,n_out_max=n_out*3,q_norm=1,r)
t2=Sys.time()
t_sphmc_1=difftime(t2,t1,units='mins')

sphmc_1_pred=bayesian_bridge_predict(xx_train,y_train,G,xx_test,newG,sphmc_1)
rmse_sphmc_1 <- sqrt(mean((sphmc_1_pred-y_test)^2))/sd(y_test)

t1=Sys.time()
sphmc_2=bayesian_bridge_sphmc_adp_convergence2(xx_train,y_train,prior_var,G,n_in,n_adpt=n_out*0.8,n_out_min=n_out*1.5,n_out_max=n_out*3,q_norm=1.8,r)
t2=Sys.time()
t_sphmc_2=difftime(t2,t1,units='mins')

sphmc_2_pred=bayesian_bridge_predict(xx_train,y_train,G,xx_test,newG,sphmc_2)
rmse_sphmc_2 <- sqrt(mean((sphmc_2_pred-y_test)^2))/sd(y_test)

t1=Sys.time()
hmc=bayesian_bridge_sphmc_adp_hmc_convergence2(xx_train,y_train,prior_var,G,n_in,n_adpt=n_out*0.8,n_out_min=n_out*1.5,n_out_max=n_out*3,l=l,rou=rou)
t2=Sys.time()
t_hmc=difftime(t2,t1,units='mins')

hmc_pred=bayesian_bridge_predict(xx_train,y_train,G,xx_test,newG,hmc)
rmse_hmc <- sqrt(mean((hmc_pred-y_test)^2))/sd(y_test)

result=data.frame(task_id=task_id, rmse_mlegp=rmse_mlegp,t_mlegp=t_mlegp,rmse_lagp=rmse_lagp,t_lagp=t_lagp,rmse_sphmc_0.8=rmse_sphmc_0.8,t_sphmc_0.8=t_sphmc_0.8,rmse_sphmc_1=rmse_sphmc_1,t_sphmc_1=t_sphmc_1,rmse_sphmc_2=rmse_sphmc_2,t_sphmc_2=t_sphmc_2,rmse_hmc=rmse_hmc,t_hmc=t_hmc)
...
write.table(result,file='result/water/test_water.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/water/test_water.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/water/test_water_0.8_parameters.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/water/test_water_0.8_parameters.csv'),append=TRUE)

write.table(result_parameters_1,file='result/water/test_water_1_parameters.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/water/test_water_1_parameters.csv'),append=TRUE)

write.table(result_parameters_2,file='result/water/test_water_2_parameters.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/water/test_water_2_parameters.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/water/test_water_hmc_parameters.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/water/test_water_hmc_parameters.csv'),append=TRUE)
...
file_path=sprintf(
  'result/water/parameter_0.8/beta/test_water_0.8_beta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_0.8/omega/test_water_0.8_omega_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_0.8/tau_square/test_water_0.8_tau_square_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_0.8/eta/test_water_0.8_eta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_1/beta/test_water_1_beta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_1/omega/test_water_1_omega_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_1/tau_square/test_water_1_tau_square_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_1/eta/test_water_1_eta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_2/beta/test_water_2_beta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_2/omega/test_water_2_omega_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_2/tau_square/test_water_2_tau_square_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_2/eta/test_water_2_eta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_hmc/beta/test_water_hmc_beta_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_hmc/omega/test_water_hmc_omega_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_hmc/tau_square/test_water_hmc_tau_square_record_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/water/parameter_hmc/eta/test_water_hmc_eta_record_%s.csv',
  task_id
)
