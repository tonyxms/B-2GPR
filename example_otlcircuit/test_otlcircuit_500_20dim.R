#Example for the OTL Circuit function with increased input dimension d = 20, training set size n = 500, and test set size m = 1000.
library(invgamma)
library(lhs)
library(abind)
library(mlegp)
...
write.table(result,file='result/otlcircuit_500_20/test_otlcircuit_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500_20/test_otlcircuit_500_20.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/otlcircuit_500_20/test_otlcircuit_0.8_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500_20/test_otlcircuit_0.8_parameters_500_20.csv'),append=TRUE)

write.table(result_parameters_1,file='result/otlcircuit_500_20/test_otlcircuit_1_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500_20/test_otlcircuit_1_parameters_500_20.csv'),append=TRUE)

write.table(result_parameters_2,file='result/otlcircuit_500_20/test_otlcircuit_2_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500_20/test_otlcircuit_2_parameters_500_20.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/otlcircuit_500_20/test_otlcircuit_hmc_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500_20/test_otlcircuit_hmc_parameters_500_20.csv'),append=TRUE)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_0.8/beta/test_otlcircuit_0.8_beta_record_500_20_%s.csv',
  task_id
)
write.table(record_0.8_beta,file=file_path,sep=',',row.names=TRUE,col.names=FALSE,append=TRUE)

record_0.8_omega=matrix(sphmc_0.8$omega_record,nrow=dim(sphmc_0.8$omega_record)[1],ncol=dim(sphmc_0.8$omega_record)[2])
record_0.8_omega=data.frame(task_id=task_id,method='sphmc_0.8',record_0.8_omega)
rownames(record_0.8_omega)=name2
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_0.8/omega/test_otlcircuit_0.8_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_0.8/tau_square/test_otlcircuit_0.8_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_0.8/eta/test_otlcircuit_0.8_eta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_1/beta/test_otlcircuit_1_beta_record_500_20_%s.csv',
  task_id
)
write.table(record_1_beta,file=file_path,sep=',',row.names=TRUE,col.names=FALSE,append=TRUE)

record_1_omega=matrix(sphmc_1$omega_record,nrow=dim(sphmc_1$omega_record)[1],ncol=dim(sphmc_1$omega_record)[2])
record_1_omega=data.frame(task_id=task_id,method='sphmc_1',record_1_omega)
rownames(record_1_omega)=name2
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_1/omega/test_otlcircuit_1_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_1/tau_square/test_otlcircuit_1_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_1/eta/test_otlcircuit_1_eta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_2/beta/test_otlcircuit_2_beta_record_500_20_%s.csv',
  task_id
)
write.table(record_2_beta,file=file_path,sep=',',row.names=TRUE,col.names=FALSE,append=TRUE)

record_2_omega=matrix(sphmc_2$omega_record,nrow=dim(sphmc_2$omega_record)[1],ncol=dim(sphmc_2$omega_record)[2])
record_2_omega=data.frame(task_id=task_id,method='sphmc_2',record_2_omega)
rownames(record_2_omega)=name2
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_2/omega/test_otlcircuit_2_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_2/tau_square/test_otlcircuit_2_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_2/eta/test_otlcircuit_2_eta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_hmc/beta/test_otlcircuit_hmc_beta_record_500_20_%s.csv',
  task_id
)
write.table(record_hmc_beta,file=file_path,sep=',',row.names=TRUE,col.names=FALSE,append=TRUE)

record_hmc_omega=matrix(hmc$omega_record,nrow=dim(hmc$omega_record)[1],ncol=dim(hmc$omega_record)[2])
record_hmc_omega=data.frame(task_id=task_id,method='hmc',record_hmc_omega)
rownames(record_hmc_omega)=name2
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_hmc/omega/test_otlcircuit_hmc_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_hmc/tau_square/test_otlcircuit_hmc_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500_20/parameter_hmc/eta/test_otlcircuit_hmc_eta_record_500_20_%s.csv',
  task_id
)
