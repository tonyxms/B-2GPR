...
t1=Sys.time()
kriging_quadratic=km(~(.)^2+ I(X1^2) + I(X2^2) + I(X3^2) + I(X4^2) + I(X5^2) +I(X6^2) ,design=xx.train,response=y.train,covtype="gauss",nugget.estim = TRUE)
t2=Sys.time()
...
write.table(result,file='result/otlcircuit_500/test_otlcircuit_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500/test_otlcircuit_500.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/otlcircuit_500/test_otlcircuit_0.8_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500/test_otlcircuit_0.8_parameters_500.csv'),append=TRUE)

write.table(result_parameters_1,file='result/otlcircuit_500/test_otlcircuit_1_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500/test_otlcircuit_1_parameters_500.csv'),append=TRUE)

write.table(result_parameters_2,file='result/otlcircuit_500/test_otlcircuit_2_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500/test_otlcircuit_2_parameters_500.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/otlcircuit_500/test_otlcircuit_hmc_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/otlcircuit_500/test_otlcircuit_hmc_parameters_500.csv'),append=TRUE)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_0.8/beta/test_otlcircuit_0.8_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_0.8/omega/test_otlcircuit_0.8_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_0.8/tau_square/test_otlcircuit_0.8_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_0.8/eta/test_otlcircuit_0.8_eta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_1/beta/test_otlcircuit_1_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_1/omega/test_otlcircuit_1_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_1/tau_square/test_otlcircuit_1_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_1/eta/test_otlcircuit_1_eta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_2/beta/test_otlcircuit_2_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_2/omega/test_otlcircuit_2_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_2/tau_square/test_otlcircuit_2_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_2/eta/test_otlcircuit_2_eta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_hmc/beta/test_otlcircuit_hmc_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_hmc/omega/test_otlcircuit_hmc_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_hmc/tau_square/test_otlcircuit_hmc_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/otlcircuit_500/parameter_hmc/eta/test_otlcircuit_hmc_eta_record_500_%s.csv',
  task_id
)
