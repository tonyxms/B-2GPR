...
result_otlcircuit <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_200/test_otlcircuit_200.csv",
  header = TRUE, check.names = FALSE
)

# Posterior‑parameter CSVs for three q values
result_otlcircuit_parameter_0.8 <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_200/test_otlcircuit_0.8_parameters_200.csv",
  header = TRUE, check.names = FALSE
)
result_otlcircuit_parameter_1 <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_200/test_otlcircuit_1_parameters_200.csv",
  header = TRUE, check.names = FALSE
)
result_otlcircuit_parameter_2 <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_200/test_otlcircuit_2_parameters_200.csv",
  header = TRUE, check.names = FALSE
)
result_otlcircuit_parameter_hmc <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_200/test_otlcircuit_hmc_parameters_200.csv",
  header = TRUE, check.names = FALSE
)
...
```{r}
# ggsave("otlcircuit_200/rmse_otlcircuit_boxplot_200.png", p_rmse,
...
4. q=0.8
```{r}
conf_beta_0.8  <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_200/parameter_0.8/beta",
                             "test_otlcircuit_0.8_beta_record_200", n_beta, task_id)
conf_omega_0.8 <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_200/parameter_0.8/omega",
                             "test_otlcircuit_0.8_omega_record_200", n_omega, task_id)
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_beta_low_0.8_boxplot_200.pdf", p_low_0.8,
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_beta_high_0.8_boxplot_200.pdf", p_high_0.8,
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_omega_0.8_boxplot_200.pdf", p_omega_0.8,
#        width = 8, height = 5, dpi = 300, units = "in")
```
...
conf_beta_1  <- ci_nonzero_parallel(
  "../R2_cluster_u4/result/otlcircuit_200/parameter_1/beta",
  "test_otlcircuit_1_beta_record_200", n_beta, task_id)
conf_omega_1 <- ci_nonzero_parallel(
  "../R2_cluster_u4/result/otlcircuit_200/parameter_1/omega",
  "test_otlcircuit_1_omega_record_200", n_omega, task_id)
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_beta_low_1_boxplot_200.png", p_low_1,
#        width = 8, height = 5, dpi = 300, units = "in")
```
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_beta_high_1_boxplot_200.png", p_high_1,
#        width = 12, height = 5, dpi = 300, units = "in")
```
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_omega_1_boxplot_200.png", p_omega_1,
#        width = 8, height = 5, dpi = 300, units = "in")
```
...
conf_beta_2  <- ci_nonzero_parallel(
  "../R2_cluster_u4/result/otlcircuit_200/parameter_2/beta",
  "test_otlcircuit_2_beta_record_200", n_beta, task_id)

conf_omega_2 <- ci_nonzero_parallel(
  "../R2_cluster_u4/result/otlcircuit_200/parameter_2/omega",
  "test_otlcircuit_2_omega_record_200", n_omega, task_id)
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_beta_low_2_boxplot_200.png", p_low_2,
#        width = 8, height = 5, dpi = 300, units = "in")
```
...
#  title = expression("Boxplot for High-Order Fixed Effect coefficients " * beta),
  q_probs=c(0.015,0.98),
  var_labels = labs_high)
print(p_high_2)
```

```{r}
# ggsave("otlcircuit_200/otlcircuit_beta_high_2_boxplot_200.png", p_high_2,
#        width = 12, height = 5, dpi = 300, units = "in")
```
...
```{r}
# ggsave("otlcircuit_200/otlcircuit_omega_2_boxplot_200.png", p_omega_2,
#        width = 8, height = 5, dpi = 300, units = "in")
```
...
```{r}
# write.csv(conf_df,
#           "otlcircuit_200/confidence_counts.csv",
#           row.names = FALSE)
```
