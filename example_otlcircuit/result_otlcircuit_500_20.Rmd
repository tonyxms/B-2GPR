...
result_otlcircuit <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_500_20/test_otlcircuit_500_20.csv",
  header = TRUE, check.names = FALSE
)

result_otlcircuit_parameter_0.8 <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_500_20/test_otlcircuit_0.8_parameters_500_20.csv",
  header = TRUE, check.names = FALSE
)
result_otlcircuit_parameter_1 <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_500_20/test_otlcircuit_1_parameters_500_20.csv",
  header = TRUE, check.names = FALSE
)
result_otlcircuit_parameter_2 <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_500_20/test_otlcircuit_2_parameters_500_20.csv",
  header = TRUE, check.names = FALSE
)
result_otlcircuit_parameter_hmc <- read.csv(
  "../R2_cluster_u4/result/otlcircuit_500_20/test_otlcircuit_hmc_parameters_500_20.csv",
  header = TRUE, check.names = FALSE
)
```
...
p_rmse <- ggplot(rmse_box, aes(method, rmse)) +
  ...
  labs(x = "Method", y = "Standardised RMSE",
       title = "Standardised RMSE (otlcircuit)") +
...
```{r}
# ggsave("otlcircuit_500_20/rmse_otlcircuit_boxplot_500_20.png", p_rmse, width = 10, height = 5, dpi=300,units='in')
```
...
```{r}
q <- "0.8"
par_file <- result_otlcircuit_parameter_0.8
conf_beta_0.8  <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_500_20/parameter_0.8/beta",
                             "test_otlcircuit_0.8_beta_record_500_20", n_beta, task_id)
conf_omega_0.8 <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_500_20/parameter_0.8/omega",
                             "test_otlcircuit_0.8_omega_record_500_20", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "otlcircuit_500_20/otlcircuit_beta_0.8_boxplot_500_20.pdf",
#   plot     = p_beta_0.8,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   "otlcircuit_500_20/otlcircuit_omega_0.8_boxplot_500_20.pdf",
#   plot   = p_omega_0.8,
#   width  = 12,
#   height = 5,
#   dpi    = 300,
...
```{r}
q <- "1"
par_file <- result_otlcircuit_parameter_1
conf_beta_1  <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_500_20/parameter_1/beta",
                           "test_otlcircuit_1_beta_record_500_20", n_beta, task_id)
conf_omega_1 <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_500_20/parameter_1/omega",
                           "test_otlcircuit_1_omega_record_500_20", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "otlcircuit_500_20/otlcircuit_beta_1_boxplot_500_20.pdf",
#   plot     = p_beta_1,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   "otlcircuit_500_20/otlcircuit_omega_1_boxplot_500_20.pdf",
#   plot   = p_omega_1,
#   width  = 12,
#   height = 5,
#   dpi    = 300,
...
```{r}
q <- "2"
par_file <- result_otlcircuit_parameter_2
conf_beta_2  <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_500_20/parameter_2/beta",
                           "test_otlcircuit_2_beta_record_500_20", n_beta, task_id)
conf_omega_2 <- ci_nonzero_parallel("../R2_cluster_u4/result/otlcircuit_500_20/parameter_2/omega",
                           "test_otlcircuit_2_omega_record_500_20", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "otlcircuit_500_20/otlcircuit_beta_2_boxplot_500_20.pdf",
#   plot     = p_beta_2,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   "otlcircuit_500_20/otlcircuit_omega_2_boxplot_500_20.pdf",
#   plot   = p_omega_2,
#   width  = 12,
#   height = 5,
#   dpi    = 300,
...
```{r}
# write.csv(conf_df,
#           file      = "otlcircuit_500_20/confidence_counts.csv",
#           row.names = FALSE)
```
