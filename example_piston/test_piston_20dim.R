#Example for the Piston simulation function with increased input dimension d = 20, training set size n = 200, and test set size m = 1000.
library(invgamma)
library(lhs)
library(abind)
library(mlegp)
...
write.table(result,file='result/piston_200_20/test_piston_200_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_200_20/test_piston_200_20.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/piston_200_20/test_piston_0.8_parameters_200_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_200_20/test_piston_0.8_parameters_200_20.csv'),append=TRUE)

write.table(result_parameters_1,file='result/piston_200_20/test_piston_1_parameters_200_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_200_20/test_piston_1_parameters_200_20.csv'),append=TRUE)

write.table(result_parameters_2,file='result/piston_200_20/test_piston_2_parameters_200_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_200_20/test_piston_2_parameters_200_20.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/piston_200_20/test_piston_hmc_parameters_200_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_200_20/test_piston_hmc_parameters_200_20.csv'),append=TRUE)
...
file_path=sprintf(
  'result/piston_200_20/parameter_0.8/beta/test_piston_0.8_beta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_0.8/omega/test_piston_0.8_omega_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_0.8/tau_square/test_piston_0.8_tau_square_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_0.8/eta/test_piston_0.8_eta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_1/beta/test_piston_1_beta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_1/omega/test_piston_1_omega_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_1/tau_square/test_piston_1_tau_square_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_1/eta/test_piston_1_eta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_2/beta/test_piston_2_beta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_2/omega/test_piston_2_omega_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_2/tau_square/test_piston_2_tau_square_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_2/eta/test_piston_2_eta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_hmc/beta/test_piston_hmc_beta_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_hmc/omega/test_piston_hmc_omega_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_hmc/tau_square/test_piston_hmc_tau_square_record_200_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_200_20/parameter_hmc/eta/test_piston_hmc_eta_record_200_20_%s.csv',
  task_id
)
