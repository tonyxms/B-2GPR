#Example for the Piston simulation function with original input dimension d = 7, training set size n = 500, and test set size m = 1000.
library(invgamma)
library(lhs)
library(abind)
library(mlegp)
...
lower=c(30,0.005,0.002,1000,90000,290,340)
upper=c(60,0.020,0.010,5000,110000,296,360)
p=7
m=1000
n=500
...
t1=Sys.time()
kriging_quadratic=km(~(.)^2+ I(X1^2) + I(X2^2) + I(X3^2) + I(X4^2) + I(X5^2) +I(X6^2) + I(X7^2) ,design=xx.train,response=y.train,covtype="gauss",nugget.estim = TRUE)
t2=Sys.time()
t_kriging_quadratic=difftime(t2,t1,units='mins')
y_pred=predict(kriging_quadratic,newdata=x.new,type='UK',checkNames=FALSE)
rmse_kringing_quadratic=sqrt(mean((y_pred$mean-y.test)^2))/sd(y.test)
...
write.table(result,file='result/piston_500/test_piston_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_500/test_piston_500.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/piston_500/test_piston_0.8_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_500/test_piston_0.8_parameters_500.csv'),append=TRUE)

write.table(result_parameters_1,file='result/piston_500/test_piston_1_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_500/test_piston_1_parameters_500.csv'),append=TRUE)

write.table(result_parameters_2,file='result/piston_500/test_piston_2_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_500/test_piston_2_parameters_500.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/piston_500/test_piston_hmc_parameters_500.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/piston_500/test_piston_hmc_parameters_500.csv'),append=TRUE)
...
file_path=sprintf(
  'result/piston_500/parameter_0.8/beta/test_piston_0.8_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_0.8/omega/test_piston_0.8_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_0.8/tau_square/test_piston_0.8_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_0.8/eta/test_piston_0.8_eta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_1/beta/test_piston_1_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_1/omega/test_piston_1_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_1/tau_square/test_piston_1_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_1/eta/test_piston_1_eta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_2/beta/test_piston_2_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_2/omega/test_piston_2_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_2/tau_square/test_piston_2_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_2/eta/test_piston_2_eta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_hmc/beta/test_piston_hmc_beta_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_hmc/omega/test_piston_hmc_omega_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_hmc/tau_square/test_piston_hmc_tau_square_record_500_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/piston_500/parameter_hmc/eta/test_piston_hmc_eta_record_500_%s.csv',
  task_id
)
