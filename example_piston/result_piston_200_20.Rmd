...
result_piston <- read.csv(
  "../R2_cluster_u4/result/piston_200_20/test_piston_200_20.csv",
  header = TRUE, check.names = FALSE
)

result_piston_parameter_0.8 <- read.csv(
  "../R2_cluster_u4/result/piston_200_20/test_piston_0.8_parameters_200_20.csv",
  header = TRUE, check.names = FALSE
)
result_piston_parameter_1 <- read.csv(
  "../R2_cluster_u4/result/piston_200_20/test_piston_1_parameters_200_20.csv",
  header = TRUE, check.names = FALSE
)
result_piston_parameter_2 <- read.csv(
  "../R2_cluster_u4/result/piston_200_20/test_piston_2_parameters_200_20.csv",
  header = TRUE, check.names = FALSE
)
result_piston_parameter_hmc <- read.csv(
  "../R2_cluster_u4/result/piston_200_20/test_piston_hmc_parameters_200_20.csv",
  header = TRUE, check.names = FALSE
)
```
...
```{r}
# ggsave("piston_200_20/rmse_piston_boxplot_200_20.png", p_rmse, width = 10, height = 5, dpi=300,units='in')
```
...
conf_beta_0.8  <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_200_20/parameter_0.8/beta",
                             "test_piston_0.8_beta_record_200_20", n_beta, task_id)
conf_omega_0.8 <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_200_20/parameter_0.8/omega",
                             "test_piston_0.8_omega_record_200_20", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "piston_200_20/piston_beta_0.8_boxplot_200_20.pdf",
#   plot     = p_beta_0.8,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   "piston_200_20/piston_omega_0.8_boxplot_200_20.pdf",
#   plot   = p_omega_0.8,
#   width  = 12,
#   height = 5,
#   dpi    = 300,
...
conf_beta_1  <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_200_20/parameter_1/beta",
                           "test_piston_1_beta_record_200_20", n_beta, task_id)
conf_omega_1 <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_200_20/parameter_1/omega",
                           "test_piston_1_omega_record_200_20", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "piston_200_20/piston_beta_1_boxplot_200_20.pdf",
#   plot     = p_beta_1,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   "piston_200_20/piston_omega_1_boxplot_200_20.pdf",
#   plot   = p_omega_1,
#   width  = 12,
#   height = 5,
#   dpi    = 300,
...
conf_beta_2  <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_200_20/parameter_2/beta",
                           "test_piston_2_beta_record_200_20", n_beta, task_id)
conf_omega_2 <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_200_20/parameter_2/omega",
                           "test_piston_2_omega_record_200_20", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "piston_200_20/piston_beta_2_boxplot_200_20.pdf",
#   plot     = p_beta_2,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   "piston_200_20/piston_omega_2_boxplot_200_20.pdf",
#   plot   = p_omega_2,
#   width  = 12,
#   height = 5,
#   dpi    = 300,
...
```{r}
# write.csv(conf_df,
#           file      = "piston_200_20/confidence_counts.csv",
#           row.names = FALSE)
```
