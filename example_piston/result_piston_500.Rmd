...
result_piston <- read.csv(
  "../R2_cluster_u4/result/piston_500/test_piston_500.csv",
  header = TRUE, check.names = FALSE
)

result_piston_parameter_0.8 <- read.csv(
  "../R2_cluster_u4/result/piston_500/test_piston_0.8_parameters_500.csv",
  header = TRUE, check.names = FALSE
)
result_piston_parameter_1 <- read.csv(
  "../R2_cluster_u4/result/piston_500/test_piston_1_parameters_500.csv",
  header = TRUE, check.names = FALSE
)
result_piston_parameter_2 <- read.csv(
  "../R2_cluster_u4/result/piston_500/test_piston_2_parameters_500.csv",
  header = TRUE, check.names = FALSE
)
result_piston_parameter_hmc <- read.csv(
  "../R2_cluster_u4/result/piston_500/test_piston_hmc_parameters_500.csv",
  header = TRUE, check.names = FALSE
)
```
...
```{r}
# ggsave("piston_500/rmse_piston_boxplot_500.png", p_rmse,
...
conf_beta_0.8  <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_500/parameter_0.8/beta",
                             "test_piston_0.8_beta_record_500", n_beta, task_id)
conf_omega_0.8 <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_500/parameter_0.8/omega",
                             "test_piston_0.8_omega_record_500", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "piston_500/piston_beta_low_0.8_boxplot_500.pdf",
#   plot     = p_low_0.8,
#   width    = 8,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   filename = "piston_500/piston_beta_high_0.8_boxplot_500.pdf",
#   plot     = p_high_0.8,
#   width    = 13,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   filename = "piston_500/piston_omega_0.8_boxplot_500.pdf",
#   plot     = p_omega_0.8,
#   width    = 8,
#   height   = 5,
#   dpi      = 300,
...
conf_beta_1  <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_500/parameter_1/beta",
                           "test_piston_1_beta_record_500", n_beta, task_id)
conf_omega_1 <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_500/parameter_1/omega",
                           "test_piston_1_omega_record_500", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "piston_500/piston_beta_low_1_boxplot_500.png",
#   plot     = p_low_1,
#   width    = 8,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   filename = "piston_500/piston_beta_high_1_boxplot_500.png",
#   plot     = p_high_1,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   filename = "piston_500/piston_omega_1_boxplot_500.png",
#   plot     = p_omega_1,
#   width    = 8,
#   height   = 5,
#   dpi      = 300,
...
conf_beta_2  <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_500/parameter_2/beta",
                           "test_piston_2_beta_record_500", n_beta, task_id)
conf_omega_2 <- ci_nonzero_parallel("../R2_cluster_u4/result/piston_500/parameter_2/omega",
                           "test_piston_2_omega_record_500", n_omega, task_id)
...
```{r}
# ggsave(
#   filename = "piston_500/piston_beta_low_2_boxplot_500.png",
#   plot     = p_low_2,
#   width    = 8,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   filename = "piston_500/piston_beta_high_2_boxplot_500.png",
#   plot     = p_high_2,
#   width    = 12,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# ggsave(
#   filename = "piston_500/piston_omega_2_boxplot_500.png",
#   plot     = p_omega_2,
#   width    = 8,
#   height   = 5,
#   dpi      = 300,
...
```{r}
# write.csv(conf_df,
#           file      = "piston_500/confidence_counts.csv",
#           row.names = FALSE)
```
