#Example for the Borehole function with increased input dimension d = 20, training set size n = 500, and test set size m = 1000.
library(invgamma)
library(lhs)
library(abind)
library(mlegp)
...
write.table(result,file='result/borehole_500_20/test_borehole_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/borehole_500_20/test_borehole_500_20.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/borehole_500_20/test_borehole_0.8_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/borehole_500_20/test_borehole_0.8_parameters_500_20.csv'),append=TRUE)

write.table(result_parameters_1,file='result/borehole_500_20/test_borehole_1_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/borehole_500_20/test_borehole_1_parameters_500_20.csv'),append=TRUE)

write.table(result_parameters_2,file='result/borehole_500_20/test_borehole_2_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/borehole_500_20/test_borehole_2_parameters_500_20.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/borehole_500_20/test_borehole_hmc_parameters_500_20.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/borehole_500_20/test_borehole_hmc_parameters_500_20.csv'),append=TRUE)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_0.8/beta/test_borehole_0.8_beta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_0.8/omega/test_borehole_0.8_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_0.8/tau_square/test_borehole_0.8_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_0.8/eta/test_borehole_0.8_eta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_1/beta/test_borehole_1_beta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_1/omega/test_borehole_1_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_1/tau_square/test_borehole_1_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_1/eta/test_borehole_1_eta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_2/beta/test_borehole_2_beta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_2/omega/test_borehole_2_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_2/tau_square/test_borehole_2_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_2/eta/test_borehole_2_eta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_hmc/beta/test_borehole_hmc_beta_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_hmc/omega/test_borehole_hmc_omega_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_hmc/tau_square/test_borehole_hmc_tau_square_record_500_20_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/borehole_500_20/parameter_hmc/eta/test_borehole_hmc_eta_record_500_20_%s.csv',
  task_id
)
