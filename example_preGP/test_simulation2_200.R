...
beta_0=3
beta=c(-2,2,-4,4,3)
theta=c(1,1.5,2,2.5,3)
sigma2=1

k_se_ard <- function(X1, X2, theta, sigma2 = 1) {
  d2_sum <- 0
  for (j in seq_along(theta)) {
    diff  <- outer(X1[, j], X2[, j], "-")
    d2_sum <- d2_sum + (diff * theta[j])^2
  }
  sigma2 * exp(-d2_sum)
}
...
K_tr=k_se_ard(xx,xx,theta,sigma2)
z_tr=t(rmvnorm(1,sigma=K_tr))
y=beta_0+xx%*%beta+z_tr
#dis = 0.06*sd(y)
#y=y+runif(n,min=-dis,max=dis)

x.new<-randomLHS(m,p)
K_tr_te=k_se_ard(x.new,xx,theta,sigma2)
K_te=k_se_ard(x.new,x.new,theta,sigma2)
z_cond_mean=K_tr_te %*% solve(K_tr + 1e-8*diag(n), z_tr)

truey=beta_0+ x.new%*%beta + z_cond_mean
...
write.table(result,file='result/simulation2_200/test_simulation2_200.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/simulation2_200/test_simulation2_200.csv'),append=TRUE)

write.table(result_parameters_0.8,file='result/simulation2_200/test_simulation2_0.8_parameters_200.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/simulation2_200/test_simulation2_0.8_parameters_200.csv'),append=TRUE)

write.table(result_parameters_1,file='result/simulation2_200/test_simulation2_1_parameters_200.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/simulation2_200/test_simulation2_1_parameters_200.csv'),append=TRUE)

write.table(result_parameters_2,file='result/simulation2_200/test_simulation2_2_parameters_200.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/simulation2_200/test_simulation2_2_parameters_200.csv'),append=TRUE)

write.table(result_parameters_hmc,file='result/simulation2_200/test_simulation2_hmc_parameters_200.csv',sep=',',row.names=FALSE,col.names=!file.exists('result/simulation2_200/test_simulation2_hmc_parameters_200.csv'),append=TRUE)
...
file_path=sprintf(
  'result/simulation2_200/parameter_0.8/beta/test_simulation2_0.8_beta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_0.8/omega/test_simulation2_0.8_omega_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_0.8/tau_square/test_simulation2_0.8_tau_square_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_0.8/eta/test_simulation2_0.8_eta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_1/beta/test_simulation2_1_beta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_1/omega/test_simulation2_1_omega_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_1/tau_square/test_simulation2_1_tau_square_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_1/eta/test_simulation2_1_eta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_2/beta/test_simulation2_2_beta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_2/omega/test_simulation2_2_omega_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_2/tau_square/test_simulation2_2_tau_square_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_2/eta/test_simulation2_2_eta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_hmc/beta/test_simulation2_hmc_beta_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_hmc/omega/test_simulation2_hmc_omega_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_hmc/tau_square/test_simulation2_hmc_tau_square_record_200_%s.csv',
  task_id
)
...
file_path=sprintf(
  'result/simulation2_200/parameter_hmc/eta/test_simulation2_hmc_eta_record_200_%s.csv',
  task_id
)
